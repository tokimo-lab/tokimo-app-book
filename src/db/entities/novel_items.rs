...
#[sea_orm(table_name = "novel_items")]
pub struct Model {
    ...
    #[sea_orm(
        column_type = "Text",
        nullable,
        unique_key = "novel_items_source_provider_source_book_id_key"
    )]
...
pub enum Relation {
    ...
    NovelCollections,
    #[sea_orm(has_many = "super::novel_files::Entity")]
    NovelFiles,
...
impl Related<super::novel_files::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NovelFiles.def()
    }
}
...
impl Related<super::collections::Entity> for Entity {
    ...
    fn via() -> Option<RelationDef> {
        Some(super::novel_collections::Relation::NovelItems.def().rev())
    }
}
...
impl Related<super::genres::Entity> for Entity {
    ...
    fn via() -> Option<RelationDef> {
        Some(super::novel_genres::Relation::NovelItems.def().rev())
    }
}
